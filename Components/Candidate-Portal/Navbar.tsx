            ...
            <div className="h-14 flex items-center justify-between gap-3 md:gap-6 px-4 md:px-6 relative">
              ...
              <div className="flex items-center gap-3 md:gap-6">
                ...
                <div className="hidden md:flex items-center gap-6 ml-4 md:ml-6">
                  ...
                  <h3 className="text-base font-medium text-(--profile-menu-text-color) cursor-pointer">Pricing</h3>
                  <h3 className="text-base font-medium text-(--profile-menu-text-color) cursor-pointer">About</h3>
                  <h3 className="text-base font-medium text-(--profile-menu-text-color) cursor-pointer">Contact</h3>
                  {/* 
          ...
          <Sheet open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
            ...
            >
              <div className="flex flex-col h-full bg-white rounded-tr-2xl relative">
                ...
                <SheetClose className={`absolute -right-12 top-4 z-50 w-10 h-10 flex items-center justify-center rounded-full bg-white shadow-md hover:bg-gray-50 transition-all duration-300 ${showCloseButton
